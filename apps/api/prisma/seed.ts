...
const CATALOG: { category: string; products: ProductSpec[] }[] = [
  {
    ...
    products: [
      ...
      { name: "Mangoes (Alphonso)", unit: "1 kg", basePrice: 280 },
      { name: "Watermelon", unit: "1 pc", basePrice: 70 },
      { name: "Ginger", unit: "250 g", basePrice: 40 },
      { name: "Garlic", unit: "250 g", basePrice: 60 },
      { name: "Coriander", unit: "1 bunch", basePrice: 20 },
    ],
  },
  {
    category: "Dairy & Eggs",
    products: [
      ...
      { name: "Mozzarella", unit: "200 g", basePrice: 180 },
      { name: "Condensed Milk", unit: "400 g", basePrice: 130 },
      { name: "Whipping Cream", unit: "250 ml", basePrice: 120 },
      { name: "Greek Curd", unit: "400 g", basePrice: 90 },
      { name: "Cheese Spread", unit: "180 g", basePrice: 110 },
    ],
  },
  {
    ...
    products: [
      ...
      { name: "Garlic Bread", unit: "200 g", basePrice: 70 },
      { name: "Pita Bread", unit: "5 pcs", basePrice: 55 },
      { name: "Cream Crackers", unit: "200 g", basePrice: 45 },
      { name: "Popcorn", unit: "100 g", basePrice: 40 },
      { name: "Granola Bars", unit: "6 pcs", basePrice: 150 },
    ],
  },
  {
    ...
    products: [
      ...
      { name: "Urad Dal", unit: "1 kg", basePrice: 120 },
      { name: "Quinoa", unit: "500 g", basePrice: 220 },
      { name: "Olive Oil", unit: "500 ml", basePrice: 380 },
      { name: "Vermicelli", unit: "400 g", basePrice: 50 },
      { name: "Jaggery", unit: "500 g", basePrice: 60 },
    ],
  },
  {
    category: "Beverages",
    products: [
      ...
      { name: "Apple Juice", unit: "1 L", basePrice: 110 },
      { name: "Iced Tea", unit: "500 ml", basePrice: 60 },
      { name: "Soda Water", unit: "750 ml", basePrice: 35 },
      { name: "Hot Chocolate Mix", unit: "200 g", basePrice: 180 },
      { name: "Tender Coconut Water", unit: "1 L", basePrice: 90 },
    ],
  },
  {
    ...
    products: [
      ...
      { name: "Conditioner", unit: "180 ml", basePrice: 150 },
      { name: "Glass Cleaner", unit: "500 ml", basePrice: 90 },
      { name: "Scrub Pad", unit: "3 pcs", basePrice: 40 },
      { name: "Air Freshener", unit: "250 ml", basePrice: 199 },
      { name: "Laundry Liquid", unit: "1 L", basePrice: 210 },
    ],
  },
];
